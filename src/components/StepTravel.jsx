  ...
  <section className='grid md:grid-cols-3 gap-4'>
    <div className='card p-4'>
      ...
      <input
        ...
        onChange={e => setS(cur => ({ ...cur, averageTravelCostPerChange: Number(e.target.value) || 0 }))}
      />
    </div>
    ...
    <div className='card p-4'>
      ...
      <input
        ...
        onChange={e => setS(cur => ({ ...cur, latePctToday: Number(e.target.value) || 0 }))}
      />
    ...
    <div className='card p-4'>
      ...
      />
      <p className='hint mt-2'>Used to estimate extra savings from multi-agency tendering.</p>
    </div>
  </section>
)
